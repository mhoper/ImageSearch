...
public class ZoomableNetworkImageView extends NetworkImageView implements ZoomableComponent, Scalable {
	...
	private OnImageNotChangedListener onImageNotChangedListener = null;
	/**
	 * <pre>
	...
	private void callListenerIfImageChanged() {
		...
		if (imageChanged == true && onImageChangedListener != null) {
			System.out.println("-------callListenerIfImageChanged onImageChanged---------");
		...
		if (imageChanged == false && onImageNotChangedListener != null){
			System.out.println("-------callListenerIfImageChanged onImageNotChanged---------");
			this.setScaleType(ScaleType.CENTER);
			// Don't call a listener immediately, because needed ui processes may remains before listener is called.
			post(new Runnable(){
				@Override
				public void run() {
						onImageNotChangedListener.onImageNotChanged(ZoomableNetworkImageView.this);
				}});
	...
	public void setOnImageNotChangedListener(OnImageNotChangedListener listener) {
		this.onImageNotChangedListener = listener;
	}

	public void removeOnImageNotChangedListener() {
		this.onImageNotChangedListener = null;
	}
	...
	public void setImageResource(int resId) {
		...
		imageChanged = false;
		//edit by legendleo start
		callListenerIfImageChanged();
		//edit by legendleo end
	}
	...
	public Bitmap getmBitmapDisplayed() {
	...
	public boolean isScrollOver(Bitmap bitmap, float distanceX) {
		...
		return zoomExtender.isScrollOver(bitmap, distanceX);
	}
	/**
	...
	public interface OnImageNotChangedListener {
